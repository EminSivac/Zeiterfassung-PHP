...
<p><a href='http://192.168.1.3/Projekt_Emin/webterminal.php'><button>zurück</button></a></p>
...
<?php 
    if($Mitarbeiter == 8194 || $Mitarbeiter == 1124)
    {
        echo "<a href='teufel.html'><button>TEUFEL</button></a>";
    }
