...
$sqlUmziehen = "UPDATE `Mitarbeiter` SET `Export` = '$Export' WHERE `Mitarbeiter`.`UID` = $UID";
//Ausführen des SQL-Befehls
if ($conn->query($sqlUmziehen) === TRUE) 
{
    // Antwort für das Frontend
    echo "<a href='http://192.168.1.3/Projekt_Emin/export-settings.php'>Benutzter wurde gespeichert</a>";
} 
else 
{
