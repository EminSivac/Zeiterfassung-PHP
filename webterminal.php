...
<body>
    ...
    <?php
        ...
        <p>
          ...
          Über- Minusstunden Konto: <input type="text" value="<?php echo $row['zeitendifferenz'] ?>" />
        </p>
    <form method="post" action="webterminal.php">
    <input type="hidden" id="MitarbeiterID" name="MitarbeiterID" value="<?php echo $Mitarbeiter ?>" />
    <input type="hidden" id="PIN" name="PIN" value="<?php echo $PIN ?>" />
    ...
    <?php
      ...
      <?php
        ...
        {
            echo "Die Eingabe ist falsch  <a href='http://192.168.1.3/Projekt_Emin/webterminal.html'>Versuche es nochmal!</a>";
        }
        $conn->close();
