<?php 
    ...
    function neuenMitarbeiterInsert($conn, $MitarbeiterID, $Vorname, $Nachname, $Email)
    {
        ...
        VALUES (NULL, '$MitarbeiterID', '', '', '', '', 'Montag');INSERT INTO `Sollzeiten` (`UID`, `MitarbeiterID`, `BeginnZeit`, `EndeZeit`, `DauerPausen`, `DauerArbeitszeit`, `Wochentag`) 
        VALUES (NULL, '$MitarbeiterID', '', '', '', '', 'Dienstag');INSERT INTO `Sollzeiten` (`UID`, `MitarbeiterID`, `BeginnZeit`, `EndeZeit`, `DauerPausen`, `DauerArbeitszeit`, `Wochentag`) 
        VALUES (NULL, '$MitarbeiterID', '', '', '', '', 'Mittwoch');INSERT INTO `Sollzeiten` (`UID`, `MitarbeiterID`, `BeginnZeit`, `EndeZeit`, `DauerPausen`, `DauerArbeitszeit`, `Wochentag`) 
        VALUES (NULL, '$MitarbeiterID', '', '', '', '', 'Donnerstag');INSERT INTO `Sollzeiten` (`UID`, `MitarbeiterID`, `BeginnZeit`, `EndeZeit`, `DauerPausen`, `DauerArbeitszeit`, `Wochentag`) 
        VALUES (NULL, '$MitarbeiterID', '', '', '', '', 'Freitag');";
        ...
        {
            echo "Error: " . $sqlNeuenMitarbeiterInsert . "<br>" . $conn->error;
        }
        ...
        {
            echo "Error: " . $sqlSollzeitenInsert . "<br>" . $conn->error;
        }
        while(mysqli_next_result($conn)){;}
