...
if ($resultMitarbeiterTest->num_rows > 0)
{
  ...
  if($Zeit == "Status")
  {
    ...
    if($case == 1)
    {
        echo "<a href='http://192.168.1.3/Projekt_Emin/shortcutTool.php'>zurück</a>";
    }
    else
    {
        echo "<a href='http://192.168.1.3/Projekt_Emin/buero.html'>Nächster Mitarbeiter</a>";
    }
    ...
    $sqlTESTPAUSE="SELECT * FROM Pausen WHERE UID = @LASTUUID AND EndePause= '00:00:00'";
      ...
      {
        //echo "Checked <a href='http://192.168.1.3/Projekt_Emin/buero.html'>Nächser Mitarbeiter</a>";
        //echo "Checked";
      } 
      else 
      {
  ...
  if($Zeit == "BeginnZeit")
  {
    ...
    {
      echo " Wurde schon eingetragen! <a href='http://192.168.1.3/Projekt_Emin/buero.html'>Versuche es nochmal!</a>";
      
    } 
    else
    {
      $sqlKommtInsert = "INSERT INTO `Arbeitszeiten` (`UID`, `MitarbeiterID`, `Datum`, `BeginnZeit`, `EndeZeit`, `DauerPausen`, `DauerArbeitszeit`) VALUES (NULL, '$Mitarbeiter', '$datum', '$uhrzeit', '', '', '')";
      ...
      {
        //echo "Checked <a href='http://192.168.1.3/Projekt_Emin/buero.html'>Nächser Mitarbeiter</a><br>Beginn Zeit";
      ...
      if ($conn->query($sqlKommtInsert) === TRUE) 
      {
        if($case == 1)
            {
                echo "Checked <a href='http://192.168.1.3/Projekt_Emin/shortcutTool.php'>zurück</a><br>Beginn Zeit";
            }
            else
            {
              echo "Checked <a href='http://192.168.1.3/Projekt_Emin/buero.html'>Nächster Mitarbeiter</a><br>Beginn Zeit";
  ...
  { 
    ...
    if ($conn->query($sqlGehtUpdate) === TRUE) 
    {
      if($case == 1)
            {
                echo "Checked <a href='http://192.168.1.3/Projekt_Emin/shortcutTool.php'>zurück</a><br>Ende Zeit";
            }
            else
            {
              echo "Checked <a href='http://192.168.1.3/Projekt_Emin/buero.html'>Nächster Mitarbeiter</a><br>Ende Zeit";
  ...
  if($Zeit == "BeginnPause")
  {
    ...
    {
      //echo "here 136";
      $sqlBeginnPause = "INSERT INTO `Pausen` (`UID`, `MitarbeiterID`, `BeginnPause`, `EndePause`, `DauerPause`, `Datum`) VALUES (NULL, $Mitarbeiter, '$uhrzeit', '', '', '$datum')";
      ...
      if ($conn->query($sqlBeginnPause) === TRUE) 
        {
          if($case == 1)
            {
                echo "Checked <a href='http://192.168.1.3/Projekt_Emin/shortcutTool.php'>zurück</a><br>Beginn Pause";
            }
            else
            {
              echo "Checked <a href='http://192.168.1.3/Projekt_Emin/buero.html'>Nächster Mitarbeiter</a><br>Beginn Pause";
    ...
    $sqlStatusUpdate = "UPDATE `Mitarbeiter` SET `Status` = 'Arbeit' WHERE `Mitarbeiter`.`MitarbeiterID` = $Mitarbeiter";
      ...
      if ($resultTESTPAUSE->num_rows > 0)
      {
        if ($conn->query($sqlEndePause2) === TRUE) 
        {
          ...
          if($case == 1)
            {
              echo "Checked <a href='http://192.168.1.3/Projekt_Emin/shortcutTool.php'>Nächster Mitarbeiter</a><br><br>Ende Pause<br><br> Deine Pause ging: " . $PausenDauer;
            }
            else
            {
              echo "Checked <a href='http://192.168.1.3/Projekt_Emin/buero.html'>Nächster Mitarbeiter</a><br><br>Ende Pause<br><br> Deine Pause ging: " . $PausenDauer;
      ...
      {
        echo "Keine Pause die beendet werden kann! <a href='http://192.168.1.3/Projekt_Emin/buero.html'>Versuche es nochmal!</a>";
      }
  }
  if($Zeit == "Rauchen")
  {
      ...
      if ($conn->query($sqlBeginnPause) === TRUE) 
        {
          if($case == 1)
            {
                echo "Checked <a href='http://192.168.1.3/Projekt_Emin/shortcutTool.php'>zurück</a><br>Pause Rauchen";
            }
            else
            {
              echo "Checked <a href='http://192.168.1.3/Projekt_Emin/buero.html'>Nächster Mitarbeiter</a><br>Pause Rauchen";
  ...
  if($Zeit == "DienstgangBeginn")
  {
    ...
    if ($resultVorhandenTest->num_rows == 1)
    {
      echo " Zuerst muss Geht gewählt werden! <a href='http://192.168.1.3/Projekt_Emin/buero.html'>Versuche es nochmal!</a>";
    } 
    else
    {
      $sqlKommtInsert = "INSERT INTO `Arbeitszeiten` (`UID`, `MitarbeiterID`, `Datum`, `BeginnZeit`, `EndeZeit`, `DauerPausen`, `DauerArbeitszeit`,`Anmerkung`) VALUES (NULL, '$Mitarbeiter', '$datum', '$uhrzeit', '', '', '','Dienstgang')";
      ...
      if ($conn->query($sqlKommtInsert) === TRUE) 
      {
        echo "Checked <a href='http://192.168.1.3/Projekt_Emin/buero.html'>Nächster Mitarbeiter</a><br>Beginn Dienstgang";
  ...
  if($Zeit == "DienstgangEnde")
  {
    ...
    if ($conn->query($sqlGehtUpdate) === TRUE) 
    {
      echo "Checked <a href='http://192.168.1.3/Projekt_Emin/buero.html'>Nächster Mitarbeiter</a><br>Ende Dienstgang<br>";
      //echo $sqlGehtUpdate;
    } 
    else 
    {
...
{
  //echo " here 198"; 
  echo "<a href='http://192.168.1.3/Projekt_Emin/buero.html'>Versuche es nochmal!</a>";
}
